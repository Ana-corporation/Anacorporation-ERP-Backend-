...
const ADMIN_PERMISSIONS = [
  ...
  { module: 'subscription', code: 'subscription:view', name: 'View Subscription (FE alias)', action: 'view' },
  { module: 'subscription', code: 'subscription:create', name: 'Create Subscription (FE alias)', action: 'create' },
  { module: 'subscription', code: 'subscription:edit', name: 'Edit Subscription (FE alias)', action: 'edit' },
  { module: 'subscription', code: 'subscription:delete', name: 'Delete Subscription (FE alias)', action: 'delete' },
  { module: 'subscription', code: 'plans:view', name: 'View Plans (FE alias)', action: 'view' },
  { module: 'subscription', code: 'plans:create', name: 'Create Plans (FE alias)', action: 'create' },
  { module: 'subscription', code: 'plans:edit', name: 'Edit Plans (FE alias)', action: 'edit' },
  { module: 'subscription', code: 'plans:delete', name: 'Delete Plans (FE alias)', action: 'delete' },
  ...
  { module: 'subscription', code: 'modules:view', name: 'View Modules (FE alias)', action: 'view' },
  { module: 'subscription', code: 'modules:create', name: 'Create Modules (FE alias)', action: 'create' },
  { module: 'subscription', code: 'modules:edit', name: 'Edit Modules (FE alias)', action: 'edit' },
  { module: 'subscription', code: 'modules:delete', name: 'Delete Modules (FE alias)', action: 'delete' },

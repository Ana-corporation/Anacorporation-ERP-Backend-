...
export class BranchesService {
  ...
  async create(companyId: string, dto: CreateBranchDto, actorId: string) {
    ...
    if (!autoGenerated && (await this.repository.findByCode(companyId, code))) {
      throw new ConflictException('Branch code already exists in this company', 'BRANCH_CODE_EXISTS');
    }
    ...
    await this.auditService.log({
      ...
      newValue: { branchCode: code, name: branch.name, autoGenerated },
    });
